...
namespace quickhull {
    ...
    template<typename FloatType> inline const FloatType getDefaultEpsilon()
        {
        return 0.0000001;
        }

    template<>
	inline const float getDefaultEpsilon<float>()
        {
        return 0.0001f;
        }
	...
	public:
		...
		ConvexHull<FloatType> getConvexHull(const std::vector<Vector3<FloatType>>& pointCloud, bool CCW, bool useOriginalIndices, FloatType eps = getDefaultEpsilon<FloatType>());
		...
		//      then we generate a new vertex buffer which contains only the vertices that are part of the convex hull.
		//   eps: minimum distance to a plane to consider a point being on positive of it (for a point cloud with scale 1)
		ConvexHull<FloatType> getConvexHull(const Vector3<FloatType>* vertexData, size_t vertexCount, bool CCW, bool useOriginalIndices, FloatType eps = getDefaultEpsilon<FloatType>());
		...
		//      then we generate a new vertex buffer which contains only the vertices that are part of the convex hull.
		//   eps: minimum distance to a plane to consider a point being on positive of it (for a point cloud with scale 1)
		ConvexHull<FloatType> getConvexHull(const FloatType* vertexData, size_t vertexCount, bool CCW, bool useOriginalIndices, FloatType eps = getDefaultEpsilon<FloatType>());
		...
		HalfEdgeMesh<FloatType, IndexType> getConvexHullAsMesh(const FloatType* vertexData, size_t vertexCount, bool CCW, FloatType eps = getDefaultEpsilon<FloatType>());
